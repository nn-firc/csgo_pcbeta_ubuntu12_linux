...
// VALVE: This only applies to Windows 95 and older, we don't need it.
...
#if defined(CRYPTOPP_MSVC6PP_OR_LATER) && !defined(MEMALIGN_OVERRIDE)
...
// VALVE: Added !defined(_M_X64) because our build helpfully defines both _M_X64 and __i386__.
#if ( defined(_M_IX86) || defined(__i386__) || defined(__i386) || defined(_X86_) || defined(__I86__) || defined(__INTEL__) ) && !defined(_M_X64)
